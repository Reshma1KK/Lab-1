  ...
  return(
    <div className="restaurant-NavBar" style={{position:"fixed",top:0,width:"100%",zIndex:"100"}}>
      ...
      <ul className="nav justify-content-end">
        ...
        <a className="nav-link active" aria-current="page" href="http://52.15.59.71:3000/PastOrders">Past orders</a>
        </li>
        <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="http://52.15.59.71:3000/CustomerLandingPage">Looking for food?</a>
        </li>
        <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="http://52.15.59.71:3000/CustomerPage">{JSON.parse(localStorage["user"])[0].name}<span style={{color:"green"}}> ,View Account</span></a>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
        <a className="nav-link" href="http://52.15.59.71:3000/" onClick={()=>{localStorage.clear();}}>Logout</a>
        </li>
      </ul>
    </div>
  )
